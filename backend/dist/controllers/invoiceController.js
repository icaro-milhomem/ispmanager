...
exports.getPaymentsByInvoice = exports.registerPayment = exports.deleteInvoice = exports.updateInvoice = exports.createInvoice = exports.getInvoiceById = exports.getAllInvoices = void 0;
...
const createInvoice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { customerId, customer_id, amount, dueDate, due_date, description } = req.body;
...
const deleteInvoice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Exclui a fatura
        yield prisma_1.prisma.invoice.delete({
            where: { id }
        });
